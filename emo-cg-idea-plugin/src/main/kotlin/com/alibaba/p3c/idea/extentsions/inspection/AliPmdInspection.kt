...
import com.alibaba.p3c.idea.extentsions.inspection.EmoLocalInspectionToolProvider.ShouldInspectChecker
import com.alibaba.p3c.idea.util.RuleInspectionUtils
...
class AliPmdInspection(private val ruleName: String) : LocalInspectionTool(),
    ...
    init {
        val ruleInfo = EmoLocalInspectionToolProvider.ruleInfoMap[ruleName]!!
