...
import com.alibaba.p3c.idea.extensionpoints.InspectionActionExtensionPoint
import com.alibaba.p3c.idea.extentsions.inspection.EmoLocalInspectionToolProvider
import com.alibaba.p3c.idea.extentsions.inspection.PmdRuleInspectionIdentify
...
class PmdGlobalInspectionContextImpl(
    ...
    private fun doPmdProcess(
        ...
        val violations =
            AliPmdProcessor(EmoLocalInspectionToolProvider.getRuleSets()).processFile(
                file,
                false
            )
